...
> Actions are consumed from the `DBMaestroDev/dbmaestro-cicd` repository using the `@v1` tag.  
> Example: `DBMaestroDev/dbmaestro-cicd/.github/actions/sh/create-package@v1`
...
- uses: DBMaestroDev/dbmaestro-cicd/.github/actions/ps/create-package@v1
  with:
    package_name: V15
    ...
```
...
jobs:
  upgrade:
    uses: DBMaestroDev/dbmaestro-cicd/.github/workflows/ps-upgrade-environment.yml@v1
    with:
      runner: 'dbmaestro-runner'
      ...
```
